...
\begin{figure*}
  ...
  If any of the highlighted pairs could occur on all plaquettes of a given color, the distance would be reduced by a factor of two.
...
While each of these highlighted correlated errors individually reduces the circuit-level distance by one, we emphasize that any one of them, if replicated across all plaquettes of the same color, would reduce the distance by a factor of two.
