...
The circuits and Python code used to generate these results are available at \url{https://github.com/Classiq/classiq-library/tree/main/algorithms/error_correction/}.
...
It may also be possible to combine the scheduling strategy from this work together with the structure of the circuits proposed in Ref.~\cite{gidney2023colorcode} which are designed with square-lattice connectivity in mind.
